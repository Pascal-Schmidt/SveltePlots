...
sp(
  ...
  sp_add_segments(
    x_start = "2000-01-01", x_end = "2000-01-05",
  ...
  sp_add_arrows(
    x_start = c("2000-03-01", "2000-02-01"), x_end = c("2000-01-01", "2000-01-01"),
...
sp <- sp(
  data = quests, 
  mapping = spaes(x = level, y = retention, group = AB),
  type = "line", 
  tooltip = F
) %>%
  sp_add_series(
